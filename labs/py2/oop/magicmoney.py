...
class Money:
    ...
    def __add__(self, other):
        d = (self.value + other.value) // 100
        c = ((self.value + other.value) / 100 - d) * 100
        return Money(d, c)
    ...
    def __le__(self, other):
        return self.value <= other.value
    def __str__(self):
        return "$"+str(self.dollars)+"."+ str((int)(self.cents)).ljust(2,'0')
    def __repr__(self):
        return "Money({}, {})".format(self.dollars,str((int)(self.cents)))
